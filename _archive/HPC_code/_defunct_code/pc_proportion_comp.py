...
df = pd.read_csv('Z:\Dinghao\code_dinghao\HPC_ephys\HPC_LC_stim_stimcont_diff_profiles_pyr_only.csv') 
pathHPCterm = rec_list.pathHPCLCtermopt
dfterm = pd.read_csv('Z:\Dinghao\code_dinghao\HPC_ephys\HPC_LCterm_stim_stimcont_diff_profiles_pyr_only.csv')
...
for pathname in pathHPC:
    ...
    if tot_pc!=0:
        ...
        clu_list = np.load(r'Z:\Dinghao\code_dinghao\HPC_ephys\all_sessions\{}\HPC_clu_list_{}.npy'.format(recname, recname))
