...
for pathname in pathHPC:
    ...
    spikes_time = file['filteredSpikeArrayRew_LasttoCurTr']
    ...
    for i in range(2):
        axs[i].set(xlabel='time from rew (s)', ylabel='pyr cell #')
    ...
    fig.savefig('Z:\Dinghao\code_dinghao\HPC_all\HPC_cont_stim_rewaligned_heatmap_cont_ordered\{}.png'.format(recname),
                dpi=500,
                bbox_inches='tight')
