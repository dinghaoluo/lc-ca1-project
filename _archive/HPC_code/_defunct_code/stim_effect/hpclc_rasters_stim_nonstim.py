# -*- coding: utf-8 -*-
"""
Created on Mon 10 July 14:52:13 2023
...
if ('Z:\Dinghao\code_dinghao\HPC_by_sess' in sys.path) == False:
    sys.path.append('Z:\Dinghao\code_dinghao\HPC_by_sess')    
...
#%% save all rasters
np.save('Z:\Dinghao\code_dinghao\HPC_all\HPC_all_rasters.npy', 
        all_rasters)
np.save('Z:\Dinghao\code_dinghao\HPC_all\HPC_all_rasters_simp_name.npy', 
        rasters)
