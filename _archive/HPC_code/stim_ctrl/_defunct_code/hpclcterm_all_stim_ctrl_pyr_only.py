...
#%% save dataframe 
df.to_csv('Z:\Dinghao\code_dinghao\HPC_all\HPC_LCterm_stim_stimcont_diff_profiles_pyr_only.csv')
df.to_pickle('Z:\Dinghao\code_dinghao\HPC_all\HPC_LCterm_stim_stimcont_diff_profiles_pyr_only.pkl')
...
np.save('Z:\Dinghao\code_dinghao\HPC_all\HPC_LCterm_stim_stimcont_shuf_MI_pyr_only.npy', shuf_MI)
np.save('Z:\Dinghao\code_dinghao\HPC_all\HPC_LCterm_stim_stimcont_shuf_MIe_pyr_only.npy', shuf_MIe)
np.save('Z:\Dinghao\code_dinghao\HPC_all\HPC_LCterm_stim_stimcont_shuf_MIl_pyr_only.npy', shuf_MIl)