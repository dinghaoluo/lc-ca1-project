# -*- coding: utf-8 -*-
"""
Created on Mon June 12 16:34:54 2023

support plots for UMAP inspection
...
for cluname in all_clu:
    ...
    if cluname in tagged_keys:
        colour = 'k'
        title = cluname + ' TAGGED'
    elif cluname in putative_keys:
        colour = 'red'
        title = cluname + ' PUTATIVE'
    else:
        colour = 'grey'
        title = cluname
    ...
    # save 
    fig.tight_layout()
    fig.savefig(r'Z:\Dinghao\code_dinghao\LC_all\UMAP_single_cell_property\{}.png'.format(title),
                dpi=300,
                bbox_inches='tight',
                transparent=False)
