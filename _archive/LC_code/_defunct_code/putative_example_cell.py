...
pathname = 'Z:\Dinghao\MiceExp\ANMD045r\A045r-20221205\A045r-20221205-03'
...
first = 5; second = 8
example1 = 'A045r-20221205-03 clu{}'.format(first)
example2 = 'A045r-20221205-03 clu{}'.format(second)
...
ax2.set(title=example2,
        xlabel='time (s)', ylabel='trial',
        ylim=(0, 82), xlim=(-3, 5))
ax1.set_yticks([1]+list(np.arange(20, 81, 20)))
ax2.set_yticks([1]+list(np.arange(20, 81, 20)))
...
spk1_avg = sr_file['all avg'][example1][:10000]
spk1_sem = sr_file['all sem'][example1][:10000]
spk2_avg = sr_file['all avg'][example2][:10000]
spk2_sem = sr_file['all sem'][example2][:10000]
...
fig.savefig('Z:\Dinghao\code_dinghao\LC_all\LC_putative_egcell.pdf',
            bbox_inches='tight')