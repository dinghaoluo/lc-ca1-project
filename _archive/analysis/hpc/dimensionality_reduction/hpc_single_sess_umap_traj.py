...
for pathname in pathHPC:
    ...
    save_figure(fig, outdirroot / 'stim_stimcont_umap.png',
    ...
    save_figure(fig, outdirroot / 'stim_stimcont_umap_dist.png',
                dpi=500, bbox_inches='tight')
...
save_figure(fig, DIM_REDUCTION_STEM / 'umap_dist_stim_stimcont.png',
            dpi=500, bbox_inches='tight')
