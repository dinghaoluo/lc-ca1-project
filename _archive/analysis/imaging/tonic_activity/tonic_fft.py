...
whole_field_figure_stem = pp.GRABNE_FIGURES_STEM / 'single_session_tonic_fft_whole_field'
grid_figure_stem = pp.GRABNE_FIGURES_STEM / 'single_session_tonic_fft_grids'
whole_field_figure_stem.mkdir(parents=True, exist_ok=True)
grid_figure_stem.mkdir(parents=True, exist_ok=True)
...
for path in pathGRABNE:
    ...
    fft_whole_field = fft(traces_whole_field - traces_whole_field.mean())  # fft of the mean-centred trace
    ...
    fig.savefig(
        whole_field_figure_stem / f'{recname}.png',
        dpi=300,
        bbox_inches='tight')
    ...
    fig.savefig(
        grid_figure_stem / f'{recname}.png',
        dpi=300,
        bbox_inches='tight')
