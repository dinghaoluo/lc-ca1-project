...
Originally named amp_autocorrelagram.py
Archived on 23 July 2026; this analysis is no longer used.
...
for path in paths:
    ...
    try:
        ...
        # do not let a failed session reuse the preceding behaviour dictionary
        continue
