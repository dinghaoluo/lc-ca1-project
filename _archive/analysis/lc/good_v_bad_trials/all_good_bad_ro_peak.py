...
from common_functions import mpl_formatting, get_trialtype_indices_from_behpar
...
for path in pathLC:
    ...
    baseline_idx, _, _ = get_trialtype_indices_from_behpar(
...
for ext in ['.png', '.pdf']:
    fig.savefig(pp.LC_EPHYS_FIGURES_STEM / f'LC_tagged_goodvbad_ROpeaking{ext}',
                dpi=300,
                bbox_inches='tight')
...
for ext in ['.png', '.pdf']:
    fig.savefig(pp.LC_EPHYS_FIGURES_STEM / f'LC_putative_goodvbad_ROpeaking{ext}',
                dpi=300,
                bbox_inches='tight')
...
pf.plot_violin_with_scatter(peak_bad_tag, peak_good_tag,
                            ...
                            save=True,
                            savepath=pp.LC_EPHYS_FIGURES_STEM / 'LC_tagged_goodvbad_ROpeaking_violin',
                            ylim=(0,9))
...
pf.plot_violin_with_scatter(peak_bad_put, peak_good_put,
                            ...
                            print_statistics=True,
                            save=True,
                            savepath=pp.LC_EPHYS_FIGURES_STEM / 'LC_putative_goodvbad_ROpeaking_violin',
                            ylim=(0,9))
