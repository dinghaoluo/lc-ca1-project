...
outpath = r'Z:\Dinghao\code_dinghao\VTA_all\VTA_all_info_alignedRew.npy'
np.save(outpath, 
        all_info)
print(f'\nprocessed and saved to {outpath}')
...
for ext in ['.png', '.pdf']:
    fig.savefig(r'Z:\Dinghao\code_dinghao\VTA_all\VTA_all_spikeavg_alignedRew{}'.format(ext),
                dpi=300,
                bbox_inches='tight')


#%% save 
np.save('Z:\Dinghao\code_dinghao\VTA_all\VTA_all_avg_sem_alignedRew.npy', 
        VTA_all_avg_sem)
...
for ext in ['.png', '.pdf']:
    fig.savefig(r'Z:\Dinghao\code_dinghao\VTA_all\VTA_all_spikeavgim_alignedRew{}'.format(ext),
                dpi=300,
                bbox_inches='tight')
