...
outpath = r'Z:\Dinghao\code_dinghao\VTA_all\VTA_all_info_alignedRun.npy'
np.save(outpath, 
        all_info)
...
for ext in ['.png', '.pdf']:
    fig.savefig(r'Z:\Dinghao\code_dinghao\VTA_all\VTA_all_spikeavg_alignedRun{}'.format(ext),
                dpi=300,
                bbox_inches='tight')


#%% save 
np.save('Z:\Dinghao\code_dinghao\VTA_all\VTA_all_avg_sem_alignedRun.npy', 
        VTA_all_avg_sem)
...
for ext in ['.png', '.pdf']:
    fig.savefig(r'Z:\Dinghao\code_dinghao\VTA_all\VTA_all_spikeavgim_alignedRun{}'.format(ext),
                dpi=300,
                bbox_inches='tight')
