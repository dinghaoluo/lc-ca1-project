...
#%% save 1
np.save(r'Z:\Dinghao\code_dinghao\VTA_all\tagged\VTA_all_tagged_info.npy', 
        all_tagged_info)
print('\nprocessed and saved to Z:\Dinghao\code_dinghao\VTA_all\tagged\VTA_all_tagged_info.npy')
...
fig.savefig(out_directory + '\\'+'VTA_all_tagged_spiketrains_alignedRun.png')
...
all_avg_sem = np.load(r'Z:\Dinghao\code_dinghao\VTA_all\VTA_all_avg_sem_alignedRun.npy',
                      allow_pickle=True).item()
...
np.save(r'Z:\Dinghao\code_dinghao\VTA_all\tagged\VTA_all_tagged_avg_sem_alignedRun.npy', 
        VTA_all_tagged_avg_sem)
...
fig.savefig(out_directory + '\\'+'VTA_all_tagged_spikeavg_alignedRun_grey.png')