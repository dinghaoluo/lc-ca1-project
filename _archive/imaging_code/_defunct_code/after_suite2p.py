...
if heatmap:
    ...
    fig.tight_layout()
    if run:
        fig.savefig(r"Z:\Jingyu\plots_20240624\example_heatmap_AC928-20240327-02-roi{}_ro_ramp.pdf".format(roi), dpi=300, transparent=True, bbox_inches="tight", format="pdf")
    if rew:
        fig.savefig(r"Z:\Jingyu\plots_20240624\example_heatmap_AC928-20240327-02-roi{}_reward_peak.pdf".format(roi), dpi=300, transparent=True, bbox_inches="tight", format="pdf")
    plt.show()
    # plt.close()
...
if trace:
    ...
    fig.tight_layout()
    if run:
        fig.savefig(r"Z:\Jingyu\plots_20240624\example_avgTrace_AC928-20240327-02-roi{}_ro_ramp.pdf".format(roi), dpi=300, transparent=False, bbox_inches="tight", format="pdf")
    if rew:
        fig.savefig(r"Z:\Jingyu\plots_20240624\example_avgTrace_AC928-20240327-02-roi{}_reward_peak.pdf".format(roi), dpi=300, transparent=False, bbox_inches="tight", format="pdf")
    plt.show()
#%% cue-onset aligned
# if align_cue==1:
