...
from common_functions import normalise, sem_gpu
...
def run_suite2p_pipeline(rec_path, recname, reg_path, txt_path,
    ...
    # #%% EXAMPLE PLOT: plot consective trials with speed and licks and dLight
    # f_start=5000
    # f_end=6000
    # roi =10
    ...
    # #%% EXAMPLE PLOT: plot heatmap for one roi:
    # # plotting parameters
    # import matplotlib
    ...
    #     fig.tight_layout()
    #     if run:
    #         fig.savefig(r"Z:\Jingyu\plots_20240624\example_heatmap_AC928-20240327-02-roi{}_ro_ramp.pdf".format(roi), dpi=120, transparent=True, bbox_inches="tight", format="pdf")
    #     if rew:
    #         fig.savefig(r"Z:\Jingyu\plots_20240624\example_heatmap_AC928-20240327-02-roi{}_reward_peak.pdf".format(roi), dpi=120, transparent=True, bbox_inches="tight", format="pdf")
    #     plt.show()
    #     # plt.close()
    ...
    #     fig.tight_layout()
    #     if run:
    #         fig.savefig(r"Z:\Jingyu\plots_20240624\example_avgTrace_AC928-20240327-02-roi{}_ro_ramp.pdf".format(roi), dpi=120, transparent=False, bbox_inches="tight", format="pdf")
    #     if rew:
    #         fig.savefig(r"Z:\Jingyu\plots_20240624\example_avgTrace_AC928-20240327-02-roi{}_reward_peak.pdf".format(roi), dpi=120, transparent=False, bbox_inches="tight", format="pdf")
    #     plt.show()u
