...
for path in paths:
    ...
    for ext in ['.png', '.pdf']:
        fig.savefig(
            pp.LC_OPTO_EPHYS_FIGURES_STEM / 'opto_020_controls' / f'{recname}_speed_curves{ext}',
            dpi=300,
            bbox_inches='tight'
            )
    ...
    for ext in ['.png', '.pdf']:
        fig.savefig(
            pp.LC_OPTO_EPHYS_FIGURES_STEM / 'opto_020_controls' / f'{recname}_mean_speeds{ext}',
            dpi=300,
            bbox_inches='tight'
            )
    ...
    for ext in ['.png', '.pdf']:
        fig.savefig(
            pp.LC_OPTO_EPHYS_FIGURES_STEM / 'opto_020_controls' / f'{recname}_speed_curves_time{ext}',
            dpi=300,
            bbox_inches='tight'
            )
...
for ext in ['.png', '.pdf']:
    fig.savefig(pp.LC_OPTO_EPHYS_FIGURES_STEM / 'opto_020_controls' / f'mean_speed_curve_dist{ext}',
...
for ext in ['.png', '.pdf']:
    fig.savefig(pp.LC_OPTO_EPHYS_FIGURES_STEM / 'opto_020_controls' / f'mean_speed_curve_time{ext}',
                dpi=300, bbox_inches='tight')
