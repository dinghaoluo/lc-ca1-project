...
analyse nLight ROI and neuropil response over time
...
for path in paths:
    ...
    releasing_mask = releasing_mask_raw & thres_mask  # new, intersection of releasing_mask and thresholded nLight, 23 Mar 2026
