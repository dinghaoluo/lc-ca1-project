...
save_stem = pp.HPC_DLIGHT_LC_OPTO_FIGURES_STEM / 'controls'
single_session_stem = save_stem / 'single_session_dLight_expression_corr'
...
for path in paths:
    ...
    for ext in ['.png', '.pdf']:
        fig.savefig(
            single_session_stem / f'{recname}_scatter{ext}',
            dpi=300,
            bbox_inches='tight'
        )
    ...
    for ext in ['.png', '.pdf']:
        fig.savefig(
            single_session_stem / f'{recname}_axon_scatter{ext}',
            dpi=300,
            bbox_inches='tight'
        )
