...
Originally named amp_baseline_rate.py
...
(GLM_stem / 'baseline_single_session_single_cell').mkdir(parents=True, exist_ok=True)
...
for path in paths:
    ...
    if not eligible_cells:
        print(f'no eligible cells for {recname}; skipped')
        continue
    ...
    for cluname, row in curr_cell_prop.iterrows():
        ...
        for _ in range(PERMS):
            ...
            _, _, r_shuf, _, _ = linregress(x_shuf, y_shuf)
