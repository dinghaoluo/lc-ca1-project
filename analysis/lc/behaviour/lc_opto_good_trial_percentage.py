...
Originally named good_perc_comp.py
...
output_stem = pp.LC_OPTO_EPHYS_FIGURES_STEM / 'opto_licktime_020'
output_stem.mkdir(parents=True, exist_ok=True)
fig.savefig(output_stem / 'goodtrialperc.png',
            dpi=500,
            bbox_inches='tight')
fig.savefig(output_stem / 'goodtrialperc.pdf',
            bbox_inches='tight')
