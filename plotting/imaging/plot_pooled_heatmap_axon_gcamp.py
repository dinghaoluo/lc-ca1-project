...
for ext in ['.png', '.pdf']:
    fig.savefig(
        pp.LCHPC_AXON_FIGURES_STEM / f'pooled_ordered_heatmap_RO_aligned{ext}',
        dpi=300,
        bbox_inches='tight'
        )
...
for ext in ['.png', '.pdf']:
    fig.savefig(
        pp.LCHPC_AXON_FIGURES_STEM / f'pooled_mean_trace_RO_peaking{ext}',
        dpi=300,
        bbox_inches='tight'
    )
...
hist_stem = pp.LCHPC_AXON_FIGURES_STEM / 'peak_time_histograms'
