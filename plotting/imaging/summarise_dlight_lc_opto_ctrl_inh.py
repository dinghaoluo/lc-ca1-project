...
for ext in ['.png', '.pdf']:
    fig.savefig(pp.HPC_DLIGHT_LC_OPTO_FIGURES_STEM / f'dLight_LC_stim_summary{ext}',
...
plot_violin_with_scatter(dFF_baselines, dFF_stims,
                         ...
                         ylim=(-0.01, 0.12),
                         save=True,
                         savepath=pp.HPC_DLIGHT_LC_OPTO_FIGURES_STEM / 'dLight_LC_stim_violin')

plot_violin_with_scatter(dFF2_baselines, dFF2_stims,
                         'darkred', 'royalblue',
                         save=True,
                         savepath=pp.HPC_DLIGHT_LC_OPTO_FIGURES_STEM / 'dLight_LC_stim_violin_ch2')
...
plot_violin_with_scatter(all_RI2, all_RI,
                         ...
                         savepath=pp.HPC_DLIGHT_LC_OPTO_FIGURES_STEM / 'dLight_LC_stim_all_summary_RI_red_green_ctrl')
...
for ext in ['.png', '.pdf']:
    fig.savefig(pp.HPC_DLIGHT_LC_OPTO_FIGURES_STEM / f'dLight_LC_stim_Dbh_inh_summary{ext}',
                dpi=300, bbox_inches='tight')
...
plot_violin_with_scatter(dFF_inh_baselines, dFF_inh_stims,
                         ...
                         ylim=(-0.04, 0.075),
                         save=True,
                         savepath=pp.HPC_DLIGHT_LC_OPTO_FIGURES_STEM / 'dLight_LC_stim_Dbh_inh_violin')

plot_violin_with_scatter(dFF2_inh_baselines, dFF2_inh_stims,
                         'darkred', 'royalblue',
                         ylim=(-0.04, 0.075),
                         save=True,
                         savepath=pp.HPC_DLIGHT_LC_OPTO_FIGURES_STEM / 'dLight_LC_stim_Dbh_inh_violin_ch2')
...
plot_violin_with_scatter(all_RI2_inh, all_RI_inh,
                         ...
                         save=True,
                         print_statistics=True,
                         savepath=pp.HPC_DLIGHT_LC_OPTO_FIGURES_STEM / 'dLight_LC_stim_all_summary_RI_red_green_nepi')
