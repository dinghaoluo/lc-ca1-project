...
summarise nLight LC-opto activation data
...
#%% path stems
nLight_stim_stem = pp.HPC_NLIGHT_LC_OPTO_STEM

all_sess_stem = nLight_stim_stem / 'all_sessions'
...
ax.plot(XAXIS, dFF_mean, color='darkgreen', label='nLight')
...
for ext in ['.png', '.pdf']:
    fig.savefig(pp.HPC_NLIGHT_LC_OPTO_FIGURES_STEM / f'nLight_LC_stim_all_summary{ext}',
...
plot_violin_with_scatter(dFF_baselines, dFF_stims,
                         ...
                         savepath=pp.HPC_NLIGHT_LC_OPTO_FIGURES_STEM / 'nLight_LC_stim_all_violin')

plot_violin_with_scatter(dFF2_baselines, dFF2_stims,
                         'darkred', 'royalblue',
                         # save=True,
                         print_statistics=True,
                         savepath=pp.HPC_NLIGHT_LC_OPTO_FIGURES_STEM / 'nLight_LC_stim_all_violin_ch2')

plot_violin_with_scatter(all_RI2, all_RI,
                         'darkred', 'darkgreen',
                         save=True,
                         print_statistics=True,
                         savepath=pp.HPC_NLIGHT_LC_OPTO_FIGURES_STEM / 'nLight_LC_stim_all_summary_RI_red_green')
