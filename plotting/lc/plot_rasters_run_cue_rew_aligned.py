...
from common_functions import colour_putative, colour_tagged
...
LC_ephys_figures_stem = pp.LC_EPHYS_FIGURES_STEM
...
for path in paths:
    ...
    for clu in tqdm(clu_list, total=len(clu_list)):
        ...
        outdir = LC_ephys_figures_stem / 'single_cell_rasters' / 'all_alignments'
