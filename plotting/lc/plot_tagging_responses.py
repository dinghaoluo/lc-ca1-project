# -*- coding: utf-8 -*-
'''
Created on Thu 24 Aug 16:21:31 2023
...
from common_functions import mpl_formatting, gaussian_kernel_unity
...
LC_tagged_stem = pp.LC_ALL_TAGGED_STEM
tagging_response_stem = pp.LC_EPHYS_FIGURES_STEM / 'tagged_only_analysis' / 'tagging_responses'
tagging_response_stem.mkdir(parents=True, exist_ok=True)
...
for cluname in all_tagged_keys:
    ...
    fullname = mice_exp_stem / f'ANMD{animalname}' / datename / recname
    ...
    for ext in ['.png', '.pdf']:
        fig.savefig(
            tagging_response_stem / f'{cluname}{ext}',
            bbox_inches='tight',
            dpi=300)
