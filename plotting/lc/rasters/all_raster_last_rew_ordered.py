...
output_no_stim = pp.LC_ALL_FIGURES_STEM / 'single_cell_raster_by_last_rew_noStim'
output_stim = pp.LC_ALL_FIGURES_STEM / 'single_cell_raster_by_last_rew'
...
for cluname in clu_list:
    ...
    temp_ordered = sorted(trial_list, key=lambda trial: pumps[trial - 1][0])
