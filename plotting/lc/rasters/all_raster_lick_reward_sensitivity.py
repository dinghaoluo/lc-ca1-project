# -*- coding: utf-8 -*-
'''
Created on Thu 11 July 17:26:45 2024
...
archive_stem = pp.LC_EPHYS_STEM / 'archive' / 'lick_sensitivity'
archive_figures_stem = pp.LC_EPHYS_FIGURES_STEM / 'archive' / 'lick_sensitivity'
output_stem = archive_figures_stem / 'single_cell_raster_with_sensitivity'
archive_stem.mkdir(parents=True, exist_ok=True)
...
for cluname in clu_list:
    ...
    rew_line, = axs['A'].plot([],[],color='darkgreen',alpha=.35,label='rew.')
...
#%% save dataframe
df.to_csv(archive_stem / 'LC_all_sensitivity_lick_reward.csv')
df.to_pickle(archive_stem / 'LC_all_sensitivity_lick_reward.pkl')
...
fig.savefig(archive_figures_stem / 'LC_all_sensitivity_lick_rew_bar.png',
            dpi=300, bbox_inches='tight')
fig.savefig(archive_figures_stem / 'LC_all_sensitivity_lick_rew_bar.pdf',
            bbox_inches='tight')
