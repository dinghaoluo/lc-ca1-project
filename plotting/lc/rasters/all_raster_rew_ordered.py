...
output_no_stim = pp.LC_ALL_FIGURES_STEM / 'single_cell_raster_by_rew_noStim'
output_stim = pp.LC_ALL_FIGURES_STEM / 'single_cell_raster_by_rew'
...
#%% save to dataframe
cell_prop = cell_prop.assign(lick_sensitive=pd.Series(rew_sensitive).values)
cell_prop = cell_prop.assign(lick_sensitive_type=pd.Series(rew_sensitive_type).values)
