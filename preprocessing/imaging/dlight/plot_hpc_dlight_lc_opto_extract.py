...
Modified on 27 May 2026

plot saved dLight LC-opto stimulation summaries, release maps, and
...
#%% paths
default_paths = (rec_list.pathdLightLCOpto + \
                 rec_list.pathdLightLCOptoCtrl + \
                 rec_list.pathdLightLCOptoInh + \
                 rec_list.pathdLightLCOptoDbhBlock)[31:]
...
def main(argv=None):
    parser = argparse.ArgumentParser(
        description='plot dLight LC-opto figures from saved extraction outputs.'
        )
    parser.add_argument(
        '--recording',
