...
plot saved GRABNE LC-opto stimulation summaries, release maps, and
...
#%% paths
default_paths = rec_list.pathGRABNELCOpto + rec_list.pathGRABNELCOptoDbhBlock
...
def main(argv=None):
    parser = argparse.ArgumentParser(
        description='plot GRABNE LC-opto figures from saved extraction outputs.'
        )
    parser.add_argument(
        '--recording',
