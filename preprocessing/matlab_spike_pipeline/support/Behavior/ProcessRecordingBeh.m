...
%     print ('-painters', '-dpng', [path recName '_numSamplesRun'], '-r600')
    barPlot(1:nSess,sessData.meanSpeedMean,sessData.meanSpeedSEM,'Session','Mean speed (mm/s)','Run onset');
    print ('-painters', '-dpng', [path recName '_meanSpeedRun'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_meanSpeedRunRun'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_maxSpeedRun'], '-r600')
...
%     print ('-painters', '-dpng', [path recName '_totRunLenTRun'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_totStopLenTRun'], '-r600')
...
%     print ('-painters', '-dpng', [path recName '_startCueToRun'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_numLicksRew'], '-r600')
...
%     print ('-painters', '-dpng', [path recName '_med1stFiveLickDistRun'], '-r600')
%     barPlot(1:nSess,sessData.medLickDistMean,sessData.medLickDistSEM,'Session','Med. dist. licks (mm)','Run onset');
%     print ('-painters', '-dpng', [path recName '_medLickDistRun'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_med1stFiveLickDistBefRew'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_medLickDistBefRewRun'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_percRewardedRun'], '-r600')
...
%     print ('-painters', '-dpng', [path recName '_percNonstopRun'], '-r600')
%     runPlot(sessData.speedProfile,(1:size(sessData.speedProfile{1},2))/1250,'Time (s)','Speed (cm/s)','Run onset');
    ...
    print ('-painters', '-dpng', [path recName '_pumpMM'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_pumpTime'], '-r600')
...
function sessData = compBehCue(path,recName,sessNo)
    ...
    print ('-painters', '-dpng', [path recName '_numSamplesCue'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_meanSpeedCue'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_meanSpeedRunCue'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_maxRunLenTCue'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_totRunLenTCue'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_numRunCue'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_meanAccCue'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_totStopLenTCue'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_med1stFiveLickDistCue'], '-r600')
    ...
    print ('-painters', '-dpng', [path recName '_medLickDistCue'], '-r600')
...
function sessData = compBehLick(path,recName,sessNo)
    ...
    saveas(gcf,[path recName '_LickDistRun.fig']);
    print ('-painters', '-dpng', [path recName '_LickDistRun'], '-r600')    
    print ('-painters', '-dpdf', [path recName '_LickDistRun'], '-r600')    
    lickPlot(sessData.Cue,param.spaceSteps/10,'Dist (cm)','No. licks','Cue onset');
    saveas(gcf,[path recName '_LickDistCue.fig']);
    print ('-painters', '-dpng', [path recName '_LickDistCue'], '-r600') 
...
function sessData = compBehSpeed(path,recName,sessNo,onlyRun)
    ...
    saveas(gcf,[path recName '_SpeedDistRun.fig']);
    print ('-painters', '-dpng', [path recName '_SpeedDistRun'], '-r600') 
    print ('-painters', '-dpdf', [path recName '_SpeedDistRun'], '-r600') 
    runPlot(sessData.Cue,param.spaceSteps/10,'Dist (cm)','Speed (cm/s)','Cue onset');
    saveas(gcf,[path recName '_SpeedDistCue.fig']);
    print ('-painters', '-dpng', [path recName '_SpeedDistCue'], '-r600') 
