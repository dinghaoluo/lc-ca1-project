function PyrModALPLRec(onlyRun)
    ...
    pathAnalSave = 'Z:\Yingxue\DataAnalysisRaphi\PyramidalALPL\';
...
%     end
    ...
    save([pathAnalSave 'autoCorrPyrALPLRec.mat'],'modPyrStatsField','modPyrStatsC',...
    ...
    plotBoxPlot(mod.phaseMeanDire(idxC == clu1),...
        mod.phaseMeanDire(idxC == clu2),'Mean theta phase direction','Pyr_ThetaMeanC1C2Box',...
    ...
    plotBoxPlot(mod.burstThetaDiff(idxC == clu1 & mod.fractBurst > 0),...
        mod.burstThetaDiff(idxC == clu2 & mod.fractBurst > 0),'Burst phase - theta phase','Pyr_BurstPhase-ThetaPhaseC1C2Box',...
    ...
    plotPolarPlot(mod.burstMeanDire(idxC == clu1 & mod.fractBurst > 0),...
        mod.burstMeanDire(idxC == clu2 & mod.fractBurst > 0),'Burst phase',...
    ...
    plotBoxPlot(mod.burstThetaDiff(modAlignedPyrStatsFNeuVsNoFNeu.indCurCFieldBurst{cluster}),...
        mod.burstThetaDiff(modAlignedPyrStatsFNeuVsNoFNeu.indCurCNoFieldBurst{cluster}),...
        'Burst phase - theta phase','Pyr_BurstPhase-ThetaPhaseC1FieldBox',...
        pathAnal,[],modAlignedPyrStatsFNeuVsNoFNeu.pWWBurstThetaDiff(cluster),colorSel);
    ...
    plotBoxPlot(mod.burstThetaDiff(modAlignedPyrStatsFNeuVsNoFNeu.indCurCFieldBurst{cluster}),...
        mod.burstThetaDiff(modAlignedPyrStatsFNeuVsNoFNeu.indCurCNoFieldBurst{cluster}),...
        'Burst phase - theta phase','Pyr_BurstPhase-ThetaPhaseC2FieldBox',...
        pathAnal,[],modAlignedPyrStatsFNeuVsNoFNeu.pWWBurstThetaDiff(cluster),colorSel);
    ...
    plotClustersFieldsPhaseLabelF(pathAnal,mod.burstThetaDiff,mod.phaseMeanDire,...
        idxC,[],[],...
    ...
    plotClustersFieldsPhaseLabelF(pathAnal,mod.burstThetaDiff,mod.phaseMeanDire,...
        idxC,mod.burstThetaDiff(indCurCField2),mod.phaseMeanDire(indCurCField2),...
        [],[],1:length(indCurCField2),...
        'Burst mean phase-Mean theta phase','Mean theta phase','All tasks',...
        'Pyr_BurstThetaDiffVsThetaMeanAll');
    set(gca,'Xlim',[-pi pi])
    ...
    plotBarPlot(autoCorrPyrAll.relDepthNeuHDef(modPyrStatsField.indCurCField{cluster}),...
        autoCorrPyrAll.relDepthNeuHDef(modPyrStatsField.indCurCNoField{cluster}),'Depth',...
        'Pyr_RelDepthNeuHDefCmpC1FieldRecBar',pathAnal,[-5 6],modPyrStatsField.pKWRelDepthNeuHDef(cluster),colorSel);
        
    plotBoxPlot(mod.fractBurst(modPyrStatsField.indCurCField{cluster}),...
        mod.fractBurst(modPyrStatsField.indCurCNoField{cluster}),'Fract burst',...
        'Pyr_FractBurstC1FieldRecBox',pathAnal,[-0.1 0.85],modPyrStatsField.pRSFractBurst(cluster),colorSel);
    
    plotBoxPlot(mod.numSpPerBurstMean(modPyrStatsField.indCurCField{cluster}),...
        mod.numSpPerBurstMean(modPyrStatsField.indCurCNoField{cluster}),'Burst length',...
        'Pyr_NumSpPerBurstMeanC1FieldRecBox',pathAnal,[1.9 3.5],modPyrStatsField.pRSNumSpPerBurstMean(cluster),colorSel);
    
    plotBoxPlot(mod.thetaModHist(modPyrStatsField.indCurCField{cluster}),...
        mod.thetaModHist(modPyrStatsField.indCurCNoField{cluster}),'Theta modulation',...
        'Pyr_ThetaModHistC1FieldRecBox',pathAnal,[0 1.2],modPyrStatsField.pRSThetaModHist(cluster),colorSel);
    
    x = mod.phaseMeanDire;
    x(x > pi) = x(x > pi) - 2*pi;
    plotBoxPlot(x(modPyrStatsField.indCurCField{cluster}),...
        x(modPyrStatsField.indCurCNoField{cluster}),'Mean theta phase',...
        'Pyr_ThetaMeanC1FieldRecBox',pathAnal,[-2 3],modPyrStatsField.pWWPhaseMeanDire(cluster),colorSel);
    
    x = mod.burstMeanDire;
    x(x > pi) = x(x > pi) - 2*pi;
    plotBoxPlot(x(modPyrStatsField.indCurCFieldBurst{cluster}),...
        x(modPyrStatsField.indCurCNoFieldBurst{cluster}),'Burst phase',...
        'Pyr_BurstMeanDirC1FieldRecBox',pathAnal,[-3 pi],modPyrStatsField.pWWBurstMeanDire(cluster),colorSel);
    
    x = mod.burstMeanDireStart;
    x(x > pi) = x(x > pi) - 2*pi;
    plotBoxPlot(x(modPyrStatsField.indCurCFieldBurst{cluster}),...
        x(modPyrStatsField.indCurCNoFieldBurst{cluster}),'Burst start phase',...
        'Pyr_BurstMeanDirStartC1FieldRecBox',pathAnal,[-3 pi],modPyrStatsField.pWWBurstMeanDireStart(cluster),colorSel);
    
    plotBoxPlot(mod.burstThetaDiff(modPyrStatsField.indCurCFieldBurst{cluster}),...
        mod.burstThetaDiff(modPyrStatsField.indCurCNoFieldBurst{cluster}),...
        'Burst phase - theta phase','Pyr_BurstPhase-ThetaPhaseC1FieldRecBox',...
        pathAnal,[],modPyrStatsField.pWWBurstThetaDiff(cluster),colorSel);
    
    plotBoxPlot(mod.thetaModFreq3(modPyrStatsField.indCurCField{cluster}),...
        mod.thetaModFreq3(modPyrStatsField.indCurCNoField{cluster}),'Theta modulation frequency (Hz)',...
        'Pyr_ThetaModFreqC1FieldRecBox',pathAnal,[4 10.5],modPyrStatsField.pRSThetaModFreq3(cluster),colorSel);
    
    plotBoxPlot(mod.diffNeuronLFPFreq(modPyrStatsField.indCurCField{cluster}),...
        mod.diffNeuronLFPFreq(modPyrStatsField.indCurCNoField{cluster}),'Neuron mod freq. - LFP freq. (Hz)',...
        'Pyr_DiffNeuronLFPFreqC1FieldRecBox',...
        pathAnal,[],modPyrStatsField.pRSDiffNeuronLFPFreq(cluster),colorSel);
    
    plotBoxPlot(mod.thetaAsym3(modPyrStatsField.indCurCField{cluster}),...
        mod.thetaAsym3(modPyrStatsField.indCurCNoField{cluster}),'Theta asymmetry',...
        'Pyr_ThetaAsymC1FieldRecBox',pathAnal,[0.1 0.85],modPyrStatsField.pRSThetaAsym3(cluster),colorSel);
    ...
    plotBarPlot(autoCorrPyrAll.relDepthNeuHDef(modPyrStatsField.indCurCField{cluster}),...
        autoCorrPyrAll.relDepthNeuHDef(modPyrStatsField.indCurCNoField{cluster}),'Depth',...
        'Pyr_RelDepthNeuHDefCmpC2FieldRecBar',pathAnal,[-5 6],modPyrStatsField.pKWRelDepthNeuHDef(cluster),colorSel);
        
    plotBoxPlot(mod.fractBurst(modPyrStatsField.indCurCField{cluster}),...
        mod.fractBurst(modPyrStatsField.indCurCNoField{cluster}),'Fract burst',...
        'Pyr_FractBurstC2FieldRecBox',pathAnal,[-0.1 0.85],modPyrStatsField.pRSFractBurst(cluster),colorSel);
    
    plotBoxPlot(mod.numSpPerBurstMean(modPyrStatsField.indCurCField{cluster}),...
        mod.numSpPerBurstMean(modPyrStatsField.indCurCNoField{cluster}),'Burst length',...
        'Pyr_NumSpPerBurstMeanC2FieldRecBox',pathAnal,[1.9 3.5],modPyrStatsField.pRSNumSpPerBurstMean(cluster),colorSel);
    
    plotBoxPlot(mod.thetaModHist(modPyrStatsField.indCurCField{cluster}),...
        mod.thetaModHist(modPyrStatsField.indCurCNoField{cluster}),'Theta modulation',...
        'Pyr_ThetaModHistC2FieldRecBox',pathAnal,[0 1.1],modPyrStatsField.pRSThetaModHist(cluster),colorSel);
    
    plotBoxPlot(mod.phaseMeanDire(modPyrStatsField.indCurCField{cluster}),...
        mod.phaseMeanDire(modPyrStatsField.indCurCNoField{cluster}),'Mean theta phase',...
        'Pyr_ThetaMeanC2FieldRecBox',pathAnal,[-0.5 6],modPyrStatsField.pWWPhaseMeanDire(cluster),colorSel);
    
    plotBoxPlot(mod.burstMeanDire(modPyrStatsField.indCurCFieldBurst{cluster}),...
        mod.burstMeanDire(modPyrStatsField.indCurCNoFieldBurst{cluster}),'Burst phase',...
        'Pyr_BurstMeanDirC2FieldRecBox',pathAnal,[],modPyrStatsField.pWWBurstMeanDire(cluster),colorSel);
    
    plotBoxPlot(mod.burstMeanDireStart(modPyrStatsField.indCurCFieldBurst{cluster}),...
        mod.burstMeanDireStart(modPyrStatsField.indCurCNoFieldBurst{cluster}),'Burst start phase',...
        'Pyr_BurstMeanDirStartC2FieldRecBox',pathAnal,[],modPyrStatsField.pWWBurstMeanDireStart(cluster),colorSel);
    
    plotBoxPlot(mod.burstThetaDiff(modPyrStatsField.indCurCFieldBurst{cluster}),...
        mod.burstThetaDiff(modPyrStatsField.indCurCNoFieldBurst{cluster}),...
        'Burst phase - theta phase','Pyr_BurstPhase-ThetaPhaseC2FieldRecBox',...
        pathAnal,[],modPyrStatsField.pWWBurstThetaDiff(cluster),colorSel);
    
    plotBoxPlot(mod.thetaModFreq3(modPyrStatsField.indCurCField{cluster}),...
        mod.thetaModFreq3(modPyrStatsField.indCurCNoField{cluster}),'Theta modulation frequency (Hz)',...
        'Pyr_ThetaModFreqC2FieldRecBox',pathAnal,[4.5 10.5],modPyrStatsField.pRSThetaModFreq3(cluster),colorSel);
    ...
    plotBoxPlot(mod.thetaAsym3(modPyrStatsField.indCurCField{cluster}),...
        mod.thetaAsym3(modPyrStatsField.indCurCNoField{cluster}),'Theta asymmetry',...
        'Pyr_ThetaAsymC2FieldRecBox',pathAnal,[0.1 0.85],modPyrStatsField.pRSThetaAsym3(cluster),colorSel);
...
function modPyr = accumPyrNeurons1(paths,filenames,mazeSess,minFR,maxFR,task,methodTheta,onlyRun)
    ...
    for i = 1:numRec
        ...
        if(length(pFRNonStimGoodStruct.indLapList) > 20) % more than 20 trirals
            [indNeuF,ia] = unique(fieldStructSess.indNeuron); 
            indNeuWithField(indNeuF) = 1;
            fieldWidth(indNeuF) = fieldStructSess.FW(ia);
            indStartField(indNeuF) = fieldStructSess.indStartField(ia);
            indPeakField(indNeuF) = fieldStructSess.indPeakField(ia);
