function [sbc, fpe, popt]=arest(v, pmin, pmax, selector, no_const)
%ARFIT	Stepwise least squares estimation of multivariate AR model (order estimation).
%
%  [w,A,C,SBC,FPE,th]=AREST(v,pmin,pmax) produces estimates of the
...
%  and rows of v representing observations.  
%
%  As order selection criteria, AREST computes approximations to
...
%  as in AREST(v,pmin,pmax,SELECTOR), SELECTOR is used as the order
