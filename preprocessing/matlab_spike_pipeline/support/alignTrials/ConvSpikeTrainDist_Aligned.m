...
%     load(fullPath,'trialsCue');
    ...
    for i  = 1:neuronNo
        ...
        for j = 1:trialNo
            ...
            avgTimePerBin = sum(timeRunTmp)/(paramC.trackLen/spaceMergeBin)/sampleFq; % added on 1/3/2022 by Yingxue   
            spikeArray = [spikeTrain(nBins-lenGaussKernel+1:nBins)...
                        spikeTrain spikeTrain(1:lenGaussKernel)]/avgTimePerBin; % added on 1/3/2022 by Yingxue
        ...
        for j = 1:trialNo 
            ...
            avgTimePerBin = sum(timeRewTmp)/(paramC.trackLen/spaceMergeBin)/sampleFq; % added on 1/3/2022 by Yingxue   
            spikeArray = [spikeTrain(nBins-lenGaussKernel+1:nBins)...
                        spikeTrain spikeTrain(1:lenGaussKernel)]/avgTimePerBin; % added on 1/3/2022 by Yingxue
        ...
        for j = 1:trialNo 
            ...
            avgTimePerBin = sum(timeCueTmp)/(paramC.trackLen/spaceMergeBin)/sampleFq; % added on 1/3/2022 by Yingxue   
            spikeArray = [spikeTrain(nBins-lenGaussKernel+1:nBins)...
                        spikeTrain spikeTrain(1:lenGaussKernel)]/avgTimePerBin; % added on 1/3/2022 by Yingxue
