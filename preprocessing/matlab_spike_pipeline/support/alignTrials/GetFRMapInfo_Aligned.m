function GetFRMapInfo_Aligned(path, fileName, mazeSess, onlyRun, intervalT)
...
% by Yingxue, 2017.08.24
    ...
    calSpatialInfo(trialNoNonStimGood,trialsRun,trialsRunSpikes,...
    ...
    calSpatialInfo(trialNoNonStimBad,trialsRun,trialsRunSpikes,...
    ...
    for i = 1:length(pulseMeth)
        ...
        calSpatialInfo(trialNoStim{i},trialsRun,trialsRunSpikes,...
        ...
        calSpatialInfo(trialNoStimCtrl{i},trialsRun,trialsRunSpikes,...
