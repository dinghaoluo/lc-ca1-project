function getBehParameters(path,fileName,mazeSess)
...
%     behPar.indTrBadBeh = behPar.totRunLenT > 13 | behPar.numRun > 10 | ...
%         behPar.totStopLenT > 2 | behPar.rewarded == -1 ...
%         | behPar.nonStop == 1 | behPar.nonFullStop == 1 ...
%         ;

    %ONLY consider stops and reward
    behPar.indTrBadBeh = behPar.rewarded == -1 ...
        | behPar.nonStop == 1 | behPar.nonFullStop == 1 ...
        ;
