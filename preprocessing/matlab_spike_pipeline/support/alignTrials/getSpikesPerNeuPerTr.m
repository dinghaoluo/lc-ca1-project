function getSpikesPerNeuPerTr(path,fileName,onlyRun,mazeSess)
...
% e.g. getSpikesPerNeuPerTr('./','A011-20190218-01_DataStructure_mazeSection1_TrialType1',1,1)
    ...
    if(onlyRun == 0)
        ...
        % added 3 Mar 2023, Dinghao, for monitoring pre-reward ramping,
        % changed by Yingxue on 3/4/2022
        trialsRewSpikes.TimeBef = perNeuPerTr(trialsRew.resBef,trialsRew.totcluBef,neuronNo,trialNo);
        trialsRewSpikes.thPhaseInterpSpikeBef = perNeuPerTr(trialsRew.thPhaseInterpSpikeBef,trialsRew.totcluBef,neuronNo,trialNo);
        
        % added 20 Dec 2023, Dinghao, for monitoring pre-cue sequences,
        % changed by Yingxue on 3/4/2022
        trialsCueSpikes.TimeBef = perNeuPerTr(trialsCue.resBef,trialsCue.totcluBef,neuronNo,trialNo);
        trialsCueSpikes.thPhaseInterpSpikeBef = perNeuPerTr(trialsCue.thPhaseInterpSpikeBef,trialsCue.totcluBef,neuronNo,trialNo);
        ...
        % added 3 Mar 2023, Dinghao, for monitoring pre-reward ramping;
        % changed by Yingxue on 03/04/2022
        trialsRewSpikes.TimeBef = ...
            perNeuPerTrRun(trialsRew.resBef,trialsRew.totcluBef,trialsRew.speed_MMsecSpikeBef,...
                           neuronNo,trialNo,minSpeed);
        trialsRewSpikes.thPhaseInterpSpikeBef = perNeuPerTrRun(trialsRew.thPhaseInterpSpikeBef,...
                           trialsRew.totcluBef,trialsRew.speed_MMsecSpikeBef,...
                           neuronNo,trialNo,minSpeed);
                       
        % added 20 Dec 2023, Dinghao, for monitoring pre-reward ramping;
        % changed by Yingxue on 03/04/2022
        trialsCueSpikes.TimeBef = ...
            perNeuPerTrRun(trialsCue.resBef,trialsCue.totcluBef,trialsCue.speed_MMsecSpikeBef,...
                           neuronNo,trialNo,minSpeed);
        trialsCueSpikes.thPhaseInterpSpikeBef = perNeuPerTrRun(trialsCue.thPhaseInterpSpikeBef,...
                           trialsCue.totcluBef,trialsCue.speed_MMsecSpikeBef,...
                           neuronNo,trialNo,minSpeed);
    ...
    save([path fileName '_alignedSpikesPerNPerT_msess' num2str(mazeSess) '_Run' num2str(onlyRun) '.mat'],...
