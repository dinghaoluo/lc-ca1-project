function meanSpikeTrainSimilarityTLastToCurTr(path,fileName,onlyRun,mazeSess,intervalT)
...
% meanSpikeTrainSimilarityT('./','A011-20190218-01_DataStructure_mazeSection1_TrialType1',1,8)
    ...
    for n = 1:neuronNo
        simArr = triu(spikeTrainSimTRun{n},1);
        simArr = simArr(:);
        ...
        simArr = triu(spikeTrainSimTRew{n},1);
        simArr = simArr(:);
        ...
        simArr = triu(spikeTrainSimTCue{n},1);
        simArr = simArr(:);
