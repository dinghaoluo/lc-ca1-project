function plotSpikeRaster_GoodVsBadBeh(path, fileName, onlyRun, mazeSess, cond, frProfile)
% plot spike rasters and separate trials based on the animal behavior
    ...
    plotSpikeRaster_aligned(path, fileName, onlyRun, mazeSess, trialNo, cond, frProfile);
