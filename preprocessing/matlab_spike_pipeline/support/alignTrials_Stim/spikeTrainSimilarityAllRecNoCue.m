function spikeTrainSimilarityAllRecNoCue(onlyRun)
...
%             meanCorrTCue.meanGood(indSelCorrT)];
    ...
    fileName1 = ['SpikeCorrTAligned_NZGood_RunVsRew_AllRec_NoCue'];
    ...
    fileName1 = ['SpikeCorrTAligned_NZGood_RunVsCue_AllRec_NoCue'];
    print('-painters','-dpdf',['Z:\Yingxue\DataAnalysisRaphi\' fileName1],'-r600');
    ...
    fileName1 = ['SpikeCorrTAligned_Good_RunVsRew_AllRec_NoCue'];
    print('-painters','-dpdf',['Z:\Yingxue\DataAnalysisRaphi\' fileName1],'-r600');
    ...
    fileName1 = ['SpikeCorrTAligned_Good_RunVsCue_AllRec_NoCue'];
    print('-painters','-dpdf',['Z:\Yingxue\DataAnalysisRaphi\' fileName1],'-r600');
end
