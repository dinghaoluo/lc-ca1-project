function [smFR, smBinP, normSmoothedFR, binnedSpikes, binnedTime, binP] =...
            binCoordiateVR(distSp,distTr,param)
    %% bin the coordinates
    ...
    smBinP = SmoothPix(binP,param.smooth/param.divDist); % changed from param.smooth to param.smooth/param.divDist on 11/7/2021
