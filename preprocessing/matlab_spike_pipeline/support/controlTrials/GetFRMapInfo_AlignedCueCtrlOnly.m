function GetFRMapInfo_AlignedCueCtrlOnly(path, fileName, mazeSess, onlyRun, intervalT)
...
% by Yingxue, 2017.08.24
    ...
    fileNameSpInfo = [fileName '_SpInfoAlignedCueCtrl_msess' num2str(mazeSess) ...
    ...
    indLaps = trialNoNonStim; % changed on 2/19/2021
    ...
    save(fullPath, 'spatialInfoSessNonStim');
end
