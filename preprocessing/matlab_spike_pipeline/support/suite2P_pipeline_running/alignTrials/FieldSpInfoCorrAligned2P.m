function fieldStruct = FieldSpInfoCorrAligned2P(pFRStruct,spatialInfo,meanCorr,paramF)
...
%         fieldStruct.peakInstFiringRateNorm(i) = peakFRTmp;
        ...
        if(isempty(indEnd))
            ...
            fieldStruct.indEndField(i) = indPeakTmp+indEnd; %% removed +1 on 5/23/2023
