function plotSpikeRasterAndRunOnT_aligned_notOrdered(path, fileName, onlyRun, mazeSess, trialNum, neuronNo, nGoodTr, tit)
...
%             figTitle = 'Spikes vs Dist';
        ...
        fileName1 = [fileName(1:indstr(1)-1) '-Neu' num2str(i) '-AlignedUnordered-' tit];
