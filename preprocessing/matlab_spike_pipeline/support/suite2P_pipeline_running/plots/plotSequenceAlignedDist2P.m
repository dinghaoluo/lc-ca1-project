function plotSequenceAlignedDist2P(path, fileName, onlyRun, mazeSess, intervalT, spaceBin, neuSel)
...
% e.g.: plotSequenceDist2P('./','A576-20210914-02_DataStructure_mazeSection1_TrialType1',1,1,10,20,2)
    ...
    fileNameConv = [fileName '_convSpikesDistAligned_msess' num2str(mazeSess) ...
        '_Run' num2str(onlyRun) '.mat'];
