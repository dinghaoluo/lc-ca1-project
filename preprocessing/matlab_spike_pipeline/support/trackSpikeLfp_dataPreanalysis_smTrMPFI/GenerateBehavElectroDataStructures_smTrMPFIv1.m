function [Spike Clu Track Laps xml] = GenerateBehavElectroDataStructures_smallTMPFIv1(path, FileNameBaseList, varargin)
...
%     load([FileNameBase '-param.mat']);
    ...
    check = Arduino2RecordT_smTr(FileNameBase,SampleRate,lfpSampleRate,nChannels);
    if(check == 1)
        return;
    end
