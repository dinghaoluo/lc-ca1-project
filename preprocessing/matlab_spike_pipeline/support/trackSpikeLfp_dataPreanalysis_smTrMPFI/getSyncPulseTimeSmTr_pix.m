function [UpCrossings] = getSyncPulseTimeSmTr_pix(baseFileName,nChannelsTot,sampleRate)
...
% default to 33, dinghao 23 Jun 2022
...
%     end
    ...
    syncCh = 1;  % check intan board connection if wrong 
    ...
    if(strcmp(baseFileName,'analogin_unstable'))
        amp = 10000;
    end
    ...
    if(~isempty(down) && ~isempty(up))
        ...
        for i = 1:lenTmp
            ...
            tmpMatch = find(tmpDiff > -sampleRate*0.002 & tmpDiff < sampleRate*0.01);
